...
kubectl apply -f 00_operator.yml --namespace ag1
...
kubectl apply -f .\storage-class.yml --namespace ag1
kubectl apply -f .\persistant-volume.yml --namespace ag1
kubectl apply -f 04_sqlserver.yml --namespace ag1
